...
const NAV_ICONS = {
  ...
  'offline docs': `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 13V7"/><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H19a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H6.5a1 1 0 0 1 0-5H20"/><path d="m9 10 3 3 3-3"/></svg>`,
  ...
  // twig top-level category — Lucide "sprout" (literal twig / young branch; kept — no Simple Icons mark exists for Twig)
  ...
  // swig top-level category — Lucide "feather" (kept — the engine has no logo; the feather doubles as the house mark)
