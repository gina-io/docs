...
Four focused follow-up sessions to close the deferred gap shown in the [Nunjucks guide](/templating/nunjucks)'s deferred-features table. Ordered by user impact.
