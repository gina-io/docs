...
Items marked ✅ are shipped. All planned items are open to community contribution — see the [GitHub repo](https://github.com/Rhinostone/gina) to get involved.
...
| **Q4 2026** | `0.4.0` | TypeScript declarations · AI agents (OpenAPI, MCP) · ScyllaDB connector · PWA scaffold · Advanced tutorial · Website redesign · Docs offline ZIP · Bun investigation · Couchbase v2 removal |
...
| 📋 | **Session storage for horizontal scaling** — Plug-in session store backed by Redis for multi-pod deployments. Default in-memory store remains available for single-pod and development. | `0.2.0` | Q2 2026 |
