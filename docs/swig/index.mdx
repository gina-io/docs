...
- **License:** MIT
- **Stable:** `1.6.0` — the current recommended version for production use.
- **Preview:** `2.0.0-alpha.1` — drop-in replacement for `1.6.0` with the internals carved into `@rhinostone/swig-core`. Same API, same compiled output, same test suite. Published on the `alpha` dist-tag. See the [Migration Guide](./migration) for the full 2.0.0 roadmap.
