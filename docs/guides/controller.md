...
Renders an HTML template using [Swig](/views/swig). The template is resolved from the route's `param.file`
...
- [Swig reference](/views/swig) — Swig syntax, tags, filters, and API
