...
sidebar_label: API
sidebar_position: 6
description: Programmatic API for @rhinostone/swig — render, compile, compileFile, compileFileAsync, renderFile, renderFileAsync, run, setFilter, setTag, setExtension, setDefaults, setDefaultTZOffset, invalidateCache, and the Swig constructor.
level: intermediate
prereqs:
