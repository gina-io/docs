...
[**notes-api.zip**](/downloads/tutorials/notes-api.zip) — extract and run `gina project:add @notes --path=$(pwd) && gina bundle:add api @notes --import && gina bundle:start api @notes`.
:::
