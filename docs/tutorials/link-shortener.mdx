...
shortener/
  src/
    api/
      ...
      templates/                   ← created by gina view:add
        html/
          content/
...
`gina view:add` (step 1) already scaffolded `src/api/templates/` with a layout and a default content page. Create the namespace subdirectory for the `links` routes:
